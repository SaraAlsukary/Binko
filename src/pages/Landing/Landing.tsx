...
const { landingContainer, landing, left, right, para, mobile, arabic, english } = Style;
const Landing = () => {
        ...
        <div className={landingContainer}>
            <Container className={landing}>
                <div className={left}>
                    ...
                    <Button onClick={() => navigate('/Binko/books')} className={language === 'Arabic' ? `${arabic} ${mobile}` : `${english} ${mobile}`} >{language === 'Arabic' ? 'تصفح' : "let's go"}</Button>
                </div>
                <div className={right}>
